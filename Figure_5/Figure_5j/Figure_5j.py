...
with MinValue(0), MaxValue(40), Color("#ef4448"):
    frame1 = XAxis() +\
             BigWig(WT_24_ChIP) +\
             Title("Wild type 24h") +\
             BigWig(WT_48_ChIP) +\
...
with MinValue(0), MaxValue(40), Color("#673ab7"):
